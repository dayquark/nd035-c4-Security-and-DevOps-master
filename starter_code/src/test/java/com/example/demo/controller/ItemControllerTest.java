...
public class ItemControllerTest {
    ...
    private Item makeItem(Long id, String name, BigDecimal price, String description) {
        Item item = new Item();
        item.setId(id);
        item.setName(name);
        item.setPrice(price);
    ...
    public void setUp(){
        ...
        allItems.add(makeItem(0L, "item1", BigDecimal.valueOf(5L),"item 1 description"));
        allItems.add(makeItem(1L, "item2", BigDecimal.valueOf(10L),"item 2 description"));
